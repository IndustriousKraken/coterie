...
pub fn create_portal_routes(state: AppState) -> Router<AppState> {
    ...
    let admin_routes = Router::new()
        ...
        .route("/members/new", get(admin::members::create::admin_new_member_page))
        .route("/members/new", post(admin::members::create::admin_create_member))
        .route("/members/:id", get(admin::members::detail::admin_member_detail_page))
        .route("/members/:id/update", post(admin::members::detail::admin_update_member))
        .route("/members/:id/activate", post(admin::members::status::admin_activate_member))
        .route("/members/:id/suspend", post(admin::members::status::admin_suspend_member))
        .route("/members/:id/extend-dues", post(admin::members::dues::admin_extend_dues))
        .route("/members/:id/set-dues", post(admin::members::dues::admin_set_dues))
        .route("/members/:id/expire-now", post(admin::members::status::admin_expire_now))
        .route("/members/:id/payments", get(admin::members::dues::admin_member_payments))
        .route("/members/:id/record-payment", get(admin::members::payments::admin_record_payment_page))
        .route("/members/:id/record-payment", post(admin::members::payments::admin_record_payment_submit))
        .route("/payments/:id/refund", post(admin::payments::admin_refund_payment))
        .route("/members/:id/resend-verification", post(admin::members::verification::admin_resend_verification))
        .route("/members/:id/discord-id", post(admin::members::discord::admin_update_discord_id))
        // Events
