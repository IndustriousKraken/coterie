...
pub fn create_portal_routes(state: AppState) -> Router<AppState> {
    Router::new()
        ...
        // Admin event routes
        .route("/admin/events", get(admin_events_page))
        .route("/admin/events/new", get(admin_new_event_page))
        .route("/admin/events/new", post(admin_create_event))
        .route("/admin/events/:id", get(admin_event_detail_page))
        .route("/admin/events/:id/update", post(admin_update_event))
        .route("/admin/events/:id/delete", post(admin_delete_event))
        // Admin announcement routes
        .route("/admin/announcements", get(admin_announcements_page))
        .route("/admin/announcements/new", get(admin_new_announcement_page))
        .route("/admin/announcements/new", post(admin_create_announcement))
        .route("/admin/announcements/:id", get(admin_announcement_detail_page))
        .route("/admin/announcements/:id/update", post(admin_update_announcement))
        .route("/admin/announcements/:id/delete", post(admin_delete_announcement))
        .route("/admin/announcements/:id/publish", post(admin_publish_announcement))
        .route("/admin/announcements/:id/unpublish", post(admin_unpublish_announcement))
...
pub struct AdminEventsQuery {
    ...
    pub time: Option<String>,  // upcoming, past, all
    pub page: Option<i64>,
    pub sort: Option<String>,
    pub order: Option<String>,
}

async fn admin_events_page(
    State(state): State<AppState>,
    headers: axum::http::HeaderMap,
    Extension(current_user): Extension<CurrentUser>,
    Extension(session_info): Extension<SessionInfo>,
    ...
    let mut filtered_events: Vec<_> = all_events.into_iter()
        .filter(|e| {
            ...
            match time_filter.as_str() {
                ...
                _ => true, // "all" or anything else shows everything
            }
        })
        .collect();
...
async fn admin_event_detail_page(
    State(state): State<AppState>,
    Extension(current_user): Extension<CurrentUser>,
    Extension(session_info): Extension<SessionInfo>,
...
async fn admin_announcements_page(
    State(state): State<AppState>,
    headers: axum::http::HeaderMap,
    Extension(current_user): Extension<CurrentUser>,
    Extension(session_info): Extension<SessionInfo>,
...
async fn admin_announcement_detail_page(
    State(state): State<AppState>,
    Extension(current_user): Extension<CurrentUser>,
    Extension(session_info): Extension<SessionInfo>,
...
async fn admin_new_announcement_page(
    State(state): State<AppState>,
    Extension(current_user): Extension<CurrentUser>,
    Extension(session_info): Extension<SessionInfo>,
) -> impl IntoResponse {
...
async fn admin_publish_announcement(
    State(state): State<AppState>,
    Extension(current_user): Extension<CurrentUser>,
    Path(announcement_id): Path<String>,
) -> impl IntoResponse {
...
async fn admin_unpublish_announcement(
    State(state): State<AppState>,
    Extension(current_user): Extension<CurrentUser>,
    Path(announcement_id): Path<String>,
) -> impl IntoResponse {
