...
// Bot-challenge config now lives in DB-backed `app_settings` (category
// `bot_challenge`), read at request time by `DynamicBotChallengeVerifier`.
// See migration 041 and `service::settings_service::get_bot_challenge_config`.
