...
- [ ] 1.1 In `src/service/series_enrollment_service.rs`, add a private
...
- [ ] 1.2 Call it as the first statement of
...
- [ ] 1.4 Extend the module doc at the top of
...
- [ ] 2.1 Add `enroll_guest_is_refused_when_every_session_has_started` in
...
- [ ] 2.2 Add `enroll_member_is_refused_when_every_session_has_started`
  for the `enroll` path with the same assertions.
- [ ] 2.3 Add `enroll_succeeds_with_one_session_remaining`: a series with
  ...
  proration.
- [ ] 2.4 Add `free_finished_class_enrollment_is_refused`: same shape as
