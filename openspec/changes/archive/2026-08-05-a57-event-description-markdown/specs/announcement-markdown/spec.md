# announcement-markdown Specification Delta

> **Capability name.** This capability was created when announcements were the
> only Markdown-bearing content. Its shared pipeline now serves event
> descriptions too; the name is historical, and the requirements below govern
> both content types.
