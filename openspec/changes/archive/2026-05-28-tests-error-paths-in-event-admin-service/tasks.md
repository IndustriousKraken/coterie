...
- [x] 1.1 `update_one_errors_when_event_id_not_found` —
...
- [x] 1.2 `cancel_event_occurrence_errors_when_series_not_found` —
...
- [x] 1.3 `cancel_event_occurrence_errors_on_zero_index` — create
...
- [x] 1.4 `override_event_occurrence_errors_when_series_not_found` —
  same shape as 1.2, but for `override_event_occurrence`. Assert
  `Err(AppError::NotFound(_))`.
- [x] 1.5 `override_event_occurrence_errors_on_zero_index` — same
  shape as 1.3, but for `override_event_occurrence`. Assert
  `Err(AppError::BadRequest(_))`.
- [x] 1.6 `restore_event_occurrence_errors_when_series_not_found` —
...
- [x] 1.7 `restore_event_occurrence_noop_when_no_exception_emits_audit` —
