...
- [x] 1.1 `create_series_errors_on_invalid_recurrence_rule` —
...
- [x] 1.2 `create_series_errors_when_until_date_before_start_time` —
...
- [x] 1.3 `compute_occurrence_start_time_errors_on_zero_index` —
  ...
  the same variant.
- [x] 1.4 `compute_occurrence_start_time_errors_when_series_has_no_events` —
  ...
  infer series anchor")`.
- [x] 1.5 `compute_occurrence_start_time_errors_on_index_beyond_horizon` —
