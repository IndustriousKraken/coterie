...
- [x] 1.1 In `src/api/handlers/public.rs::signup`, remove the
...
- [x] 2.1 Add/extend a test: in APPROVAL mode, an IP at the money-limiter
  ...
  verifier).
- [x] 2.2 Confirm the payment-mode gate-order test still passes unchanged.
